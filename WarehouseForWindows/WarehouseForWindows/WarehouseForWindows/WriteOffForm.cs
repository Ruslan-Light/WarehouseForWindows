...
namespace WarehouseForWindows
{
    public partial class WriteOffForm : Form
    {
        ...
        private async void WriteOffForm_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlCommand.CommandText = "INSERT INTO WriteOff (writeOff_date, products_list) VALUES (GETDATE(), N'" + productList + "')";
            }
            if (textBox2.Text != null)
            {
                sqlCommand.CommandText = "INSERT INTO WriteOff (writeOff_date, invoice_number, products_list) VALUES (GETDATE(), N'" + textBox2.Text + "', N'" + productList + "')";
            }
