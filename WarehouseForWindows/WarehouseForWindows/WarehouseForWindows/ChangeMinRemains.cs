...
{
    public partial class ChangeMinRemains : Form
    {
        ...
        public ChangeMinRemains()
        {
            InitializeComponent();
        }

        private async void ChangeMinRemains_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView2.Columns[0].HeaderText = "Мин. остаток";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView2.Rows.Count - 1; i++)
            {
                ...
                {
                    sqlCommand.CommandText = "UPDATE Products SET min_remains = (" + dataGridView2.Rows[i].Cells[0].Value.ToString() + ") WHERE id = " + dataGridView2.Rows[i].Cells[1].Value.ToString();
        ...
        private void ChangeMinRemains_FormClosing(object sender, FormClosingEventArgs e)
        {
            Data.someValue.Clear();
